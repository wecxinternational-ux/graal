...
// Локальная разработка: файл SQLite в server/graal.db.
// Можно также указать TURSO_DATABASE_URL для тестов с удалённой БД.
const dbUrl = process.env.TURSO_DATABASE_URL || `file:${path.join(__dirname, 'graal.db')}`;
